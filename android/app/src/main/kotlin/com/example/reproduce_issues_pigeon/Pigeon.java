...
public class Pigeon {
  ...
  public interface MessageApi {
    ...
    void getInt(@NonNull Long input);
    ...
    static void setup(BinaryMessenger binaryMessenger, MessageApi api) {
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.MessageApi.getInt", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ...
                try {
                  ...
                  assert args != null;
                  Number inputArg = (Number) args.get(0);
                  if (inputArg == null) {
                    throw new NullPointerException("inputArg unexpectedly null.");
                  }
                  api.getInt((inputArg == null) ? null : inputArg.longValue());
                  wrapped.add(0, null);
